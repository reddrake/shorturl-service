...
use Waimao\Service\ShortLink\Bitly;
...
class BitlyTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        return $this->getMockBuilder('\Waimao\Service\ShortLink\Bitly')
    ...
    {
        $this->setExpectedException('Waimao\Service\ShortLink\Exceptions\InvalidApiResponseException');
        $bitly = new \Waimao\Service\ShortLink\Bitly('fakeuser','fakepassword');
    }
