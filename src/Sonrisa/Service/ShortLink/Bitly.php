 ...
 */
namespace Waimao\Service\ShortLink;

use Waimao\Service\ShortLink\Exceptions\InvalidApiResponseException;
use Waimao\Service\ShortLink\Interfaces\ShortLinkAbstractInterface;
...
class Bitly extends ShortLinkAbstractInterface
{
     ...
     * @return mixed
     * @throws \Waimao\Service\ShortLink\Exceptions\InvalidApiResponseException
     */
